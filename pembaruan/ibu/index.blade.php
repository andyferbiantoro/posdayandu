                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                             <a href="{{ route('kader-createibu') }} "><button class="btn btn-primary">Entri Ibu Hamil</button></a>
                             <a href="{{ route('kader-createkontrol') }} "><button class="btn btn-primary">Entri Kontrol Baru</button></a>
                                    ...
                                    <tbody>
                                       ...
                                       @foreach($ibuhamil as $bumil)
                                        <tr>
                                            ...
                                            <td class="text-center">{{$bumil->tanggal}}</td>
                                            <td class="text-center">{{$bumil->ibu_hamil->nama_ibu}}</td>
                                            <td class="text-center">Ibu Hamil</td>
                                            <td align="center">
                                                <a href="{{route('ibu-detail',$bumil->id)}}"><button class="btn btn-warning">Detail</button></a>
                                                <a href="{{route('kader-editkontrol',$bumil->id)}}"><button class="btn btn-success">Edit</button></a>
                                                <a href="{{route('delete',$bumil->id)}}"><button class="btn btn-danger">Hapus</button></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
