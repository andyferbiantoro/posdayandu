...
<head>
    ...
    <title>Edit Data Kontrol Kehamilan</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">EDIT DATA KONTROL KEHAMILAN IBU</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-entriibu') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body" >
                                <form method="post" action="{{route('entri-updatekontrol')}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                             ...
                                             <div class="form-group">
                                                <label> Pilih Nama ibu hamil</label>
                                                    <select name="id_ibuhamil" class="form-control">
                                                        @foreach ($Datakontrolupdate as $update)
                                                            <option value="{{$update->id}}"> {{$update->ibu_hamil->nama_ibu}} </option>
                                                        @endforeach
                                                    </select>
                                             </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Masukkan Nama Ibu"  required="" value="{{$update->tanggal}}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="keluhan">Keluhan Sekarang</label>
                                                <input type="text" class="form-control" id="keluhan" name="keluhan" placeholder="" required="" value="{{$update->keluhan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="tekanan_darah">Tekanan Darah (mmHg)</label>
                                                <input type="text" class="form-control" id="tekanan_darah" name="tekanan_darah" placeholder="" required="" value="{{$update->tekanan_darah}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="berat_badan">Berat Badan (Kg)</label>
                                                <input type="text" class="form-control" name="berat_badan" id="berat_badan" placeholder="" required="" value="{{$update->berat_badan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="umur_kehamilan">Umur Kehamilan (Minggu)</label>
                                                <input type="text" class="form-control"  name="umur_kehamilan" id="umur_kehamilan" placeholder="" required="" value="{{$update->umur_kehamilan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="tinggi_fundus">Tinggi Fundus (Cm)</label>
                                                <input type="text" class="form-control" id="tinggi_fundus" name="tinggi_fundus" placeholder="" required="" value="{{$update->tinggi_fundus}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="letak_janin">Letak Janin Kep/Su/li</label>
                                                <input type="text" class="form-control" id="letak_janin" name="letak_janin" placeholder="" required="" value="{{$update->letak_janin}}"/>
                                            </div>
                                          ...
                                          <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="denyut_jantung_janin" name="denyut_jantung_janin" placeholder="" required="" value="{{$update->denyut_jantung_janin}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="kaki_bengkak">Kaki Bengkak (Ya/Tidak)</label>
                                                <input type="text" class="form-control" id="kaki_bengkak" name="kaki_bengkak" required="" value="{{$update->kaki_bengkak}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasil_lab">Hasil Pemeriksaan Laboratorium</label>
                                                <input type="text" class="form-control" id="hasil_lab" name="hasil_lab" required="" value="{{$update->hasil_lab}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="tindakan">Tindakan (Pemberian TT, Fe, terapi, rujukan, umpan balik)</label>
                                                <input type="text" class="form-control" id="tindakan" name="tindakan" required="" value="{{$update->tindakan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="nasihat">Nasihat Yang Disampaikan</label>
                                                <input type="text" class="form-control" id="nasihat" name="nasihat" required="" value="{{$update->nasihat}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="keterangan">Keterangan (Tempat Pelayanan, Nama Pemeriksa)</label>
                                                <input type="text" class="form-control" id="keterangan" name="keterangan" required="" value="{{$update->keterangan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="waktu_kembali">Kapan Harus Kembali</label>
                                                <input type="date" class="form-control" id="waktu_kembali" name="waktu_kembali" required="" value="{{$update->waktu_kembali}}"/>
                                            </div>
                                        </div>
