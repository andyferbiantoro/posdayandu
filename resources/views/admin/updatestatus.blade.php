    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a class="d-flex align-items-center" href="{{ route('dashboard-kader') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1"></span></a> 
                </li>
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                             <a href="{{ route('dashboard-admin') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{$kader->email}} </td>
                                            <td class="text-center">{{$kader->posyandu->nama}}</td>
                                            <td class="text-center">{{$kader->status}} </td>  
                                        </tr>
                            ...
                            <br><br>
                             <form method="post" action="{{url('admin-updatestatus',$kader->id)}}" enctype="  multipart/form-data">
                                        {{csrf_field()}}
                                <div class="row">
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">

                                            <div class="form-group">
                                                <label> Pilih Status untuk kader</label>
