    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="menu-item"><a class="d-flex align-items-center" href="{{ route('dashboard-admin') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1"></span></a> 
                </li>

                 <li class="nav-item" style="background-color: #a21000; border-radius:5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="{{ route('admin-managevideo') }}"><i data-feather="grid" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Daftar" style="color: white">Manajemen Video</span></a>
                </li>
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive"><br>
                                       <form action="{{url('admin-cari')}}" method="GET">
                                        <label> Cari Judul Video </label>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="cari" placeholder="Cari judul video .." value="{{ old('cari') }}">
                                            </div>
                                            <div class="col">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Video</th>
                                             ...
                                             <th class="text-center">Pemeran</th>
                                       ...
                                       @foreach($video as $videos)
                                        <tr>
                                            <td class="text-center">{{$no++}} </td>
                                             <td class="text-center">{{$videos->judul}} </td>
                                            <td class="text-center">
                                                <video width="300px" height="150px" controls>
                                                    <source src="uploads/video/{{$videos->nama_video}}">
                                                </video>
                                            </td>
                                            <td class="text-center">{{$videos->deskripsi}} </td>
                                            <td class="text-center">{{$videos->kategori}} </td>
                                            <td class="text-center">{{$videos->pemeran}} </td>
                                            <td><a href="{{url('admin-delete',$videos->id)}}"><button class="btn btn-danger">Hapus</button></a>
                                            </td>
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Anda yakin ingin menghapus item ini ?</h5>
                                          ...
                                          <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                             <a href="{{url('admin-delete',$videos->id)}}"><button class="btn btn-danger">Hapus</button></a>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
