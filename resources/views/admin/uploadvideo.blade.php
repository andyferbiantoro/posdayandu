    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item"><a class="d-flex align-items-center" href="{{ route('dashboard-admin') }}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1"></span></a> 
                </li>
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                             <a href="{{ route('admin-managevideo') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                            
                               <form method="post" action="{{route('admin-prosesupload')}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div  class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                <label for="nama_video">Upload Video</label>
                                                <input type="file" class="form-control" id="nama_video" name="nama_video" placeholder="" required="" />
                                            </div>        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Masukkan Deskripsi Video" required="" />
                                            </div>

                                             <div class="form-group">
                                                <label> Pilih Kaategori</label>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="pemeran" name="pemeran" placeholder="Masukkan Nama Pemeran Video" required="" />
                                            </div>
