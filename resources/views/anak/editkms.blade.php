                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">EDIT DATA KMS</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-entri') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                 <form method="post" action="{{url('anak-updatekms',$update->id)}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="berat_badan" name="berat_badan" placeholder=""  required="" value="{{$anak->berat_badan}}"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="tinggi_badan">Tinggi Badan (Cm))</label>
                                                <input type="text" class="form-control" id="tinggi_badan" name="tinggi_badan" placeholder=""  required="" value="{{$anak->tinggi_badan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="suhu_badan">Suhu Badan (Celcius))</label>
                                                <input type="text" class="form-control" id="suhu_badan" name="suhu_badan" placeholder=""  required="" value="{{$anak->suhu_badan}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="lingkar_kepala">Lingkar Kepala (Cm))</label>
                                                <input type="text" class="form-control" id="lingkar_kepala" name="lingkar_kepala" placeholder=""  required="" value="{{$anak->lingkar_kepala}}"/>
                                            </div>
