                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                             ...
                             <a href="{{ route('kader-entri') }}"><button class="btn btn-danger">Kembali</button></a><br><br>
                              @foreach($detail as $kms)
                                <h2 class="card-title">{{$kms->nama_anak}}</h2>
                                @endforeach
                                    ...
                                    <tbody>
                                       ...
                                       @foreach($detail as $kms)
                                        ...
                                        <tr>
                                        	...
                                        	<td class="text-center">{{$kms->tanggal}}</td>
                                           	<td class="text-center">{{$kms->nama_anak}}</td>
                                           	<td class="text-center">{{$kms->umurs->umur}} Bulan</td>
                                           	<td class="text-center">{{$kms->berat_badan}} Kg</td>  
                                           	<td class="text-center">{{$kms->tinggi_badan}} Cm</td>  
                                           	<td class="text-center">{{$kms->suhu_badan}} Celcius</td>  
                                           	<td class="text-center">{{$kms->lingkar_kepala}} Cm</td>
                                           	<td class="text-center">{{$kms->keterangan}}</td>
                                           	<td class="text-center">{{$kms->jenis}}</td>
