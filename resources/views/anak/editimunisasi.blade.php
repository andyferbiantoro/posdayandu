                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">EDIT DATA IMUNISASI</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-entri') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                 <form method="post" action="{{url('anak-updateimunisasi',$update->id)}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <label>Vaksin</label>
                                                <select name="nama_vaksin" class="form-control vaksin{{$errors->has('nama_vaksin') ? 'is-invalid' : '' }}">
                                                        ...
                                                        <?php $datavaksins = $Datavaksin->where('id_umur',$update->umur); ?>
                                                            @foreach($datavaksins as $vakss)
                                                            <option  value="{{$vakss->id}}"

                                                                  <?php 
                                                            if($update->nama_vaksin==$vakss->id){
                                                                echo 'selected';
                                                            }
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder=""  required="" value="{{$anak->tanggal}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="keterangan">Keterangan</label>
                                                <input type="text" class="form-control" id="keluhan" name="keterangan" placeholder="" required="" value="{{$anak->keterangan}}"/>
                                            </div>
