...
<head>
    ...
    <title>Entri Baru Data Anak</title>
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                           ...
                           <div class="card-body">
                                 <form method="post" action="{{route('anak-addanak')}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="ttl" name="ttl" placeholder=""  required=""/>
                                            </div>
