                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">ANAK</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('anak-createanak') }} "><button class="btn btn-primary">Entri Anak Baru</button></a>
                             <a href="{{ route('anak-kms') }}"><button class="btn btn-primary">Entri KMS</button></a>
                             <a href="{{ route('anak-imunisasi') }} "><button class="btn btn-primary">Entri Imunisasi</button></a>
                             <a href="{{ route('kader-entriibu') }} "><button class="btn btn-warning">Halaman Ibu</button></a>
                            
                            <div class="table-responsive"><br>
                             <form action="{{url('anak-cari')}}" method="GET">
                                        <label> Cari Anak </label>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="cari" placeholder="Cari anak" value="{{ old('cari') }}">
                                            </div>
                                            <div class="col">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                    	@php
                                            $no = 1;
                                        @endphp
                                       @foreach($Dataanak as $key => $anak)
                                        <tr>
                                        	<td class="text-center">{{$Dataanak->firstItem() + $key}} </td>
                                            <td class="text-center">{{date("j F Y", strtotime($anak->tanggal))}} </td>
                                            <td class="text-center">{{$anak->nama_anak}} </td>
                                            <td class="text-center">{{$anak->jenis}} </td>
                                            <td align="center">
                                                <a href="{{route('anak-detail',$anak->id)}}"><button class="btn btn-warning">Detail</button></a>
                                                <a href="{{url('anak-edit',$anak->id)}}"><button class="btn btn-success">Edit</button></a>
                                                <a href="{{route('anak-delete',$anak->id)}}"><button class="btn btn-danger">Hapus</button></a>
