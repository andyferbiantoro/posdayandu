...
<head>
    ...
    <title>Entri Baru Data Kontrol Kehamilan</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">TAMBAH DATA KONTROL KEHAMILAN IBU</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-entriibu') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body" >
                                <form method="post" action="{{route('ibu-datakontrolibu')}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                             ...
                                             <div class="form-group">
                                                <label> Pilih Nama ibu hamil</label>
                                                    <select name="id_ibuhamil" class="form-control">
                                                        @foreach ($Dataibu as $nama)
                                                            <option value="{{$nama->id}}"> {{$nama->ibus->nama}} </option>
                                                        @endforeach
                                                    </select>
                                             </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="Masukkan Nama Ibu"  required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="keluhan">Keluhan Sekarang</label>
                                                <input type="text" class="form-control" id="keluhan" name="keluhan" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="tekanan_darah">Tekanan Darah (mmHg)</label>
                                                <input type="text" class="form-control" id="tekanan_darah" name="tekanan_darah" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="berat_badan">Berat Badan (Kg)</label>
                                                <input type="text" class="form-control" name="berat_badan" id="berat_badan" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="umur_kehamilan">Umur Kehamilan (Minggu)</label>
                                                <input type="text" class="form-control"  name="umur_kehamilan" id="umur_kehamilan" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="tinggi_fundus">Tinggi Fundus (Cm)</label>
                                                <input type="text" class="form-control" id="tinggi_fundus" name="tinggi_fundus" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="letak_janin">Letak Janin Kep/Su/li</label>
                                                <input type="text" class="form-control" id="letak_janin" name="letak_janin" placeholder="" required=""/>
                                            </div>
                                          ...
                                          <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="denyut_jantung_janin" name="denyut_jantung_janin" placeholder="" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="kaki_bengkak">Kaki Bengkak (Ya/Tidak)</label>
                                                <input type="text" class="form-control" id="kaki_bengkak" name="kaki_bengkak" required=""/>
                                            </div>

                                            <div class="form-group">
                                                <label for="hasil_lab">Hasil Pemeriksaan Laboratorium</label>
                                                <input type="text" class="form-control" id="hasil_lab" name="hasil_lab" required=""/>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nasihat" name="nasihat" required=""/>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="waktu_kembali" name="waktu_kembali" required=""/>
                                            </div>
                                            
                                             <div class="form-group">
                                                <input type="hidden" class="form-control" id="id_posyandu" name="id_posyandu" value="{{ Auth::user()->id_posyandu }}" placeholder="" />
                                            </div>
