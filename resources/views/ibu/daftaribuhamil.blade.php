                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">DAFTAR IBU HAMIL</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('ibu-createibu') }} "><button class="btn btn-danger">kembali</button></a>
                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                      @php
                                            $no = 1;
                                        @endphp
                                       @foreach($Dataibuhamil as $bumil)
                                    <tr>
                                        
                                        <td>{{$bumil->  ibus->nama}}</td>                                      
                                        <td>{{$bumil->hpht}}</td>                                        
                                        <td>{{$bumil->htp}}</td>                                      
                                        <td>{{$bumil->lingkar_lengan}}</td>                                        
                                        <td>{{$bumil->kek}}</td>                                       
                                        <td>{{$bumil->tinggi_badan}}</td>                                       
                                        <td>{{$bumil->gol_darah}}</td>                                       
                                        <td>{{$bumil->kontrasepsi}}</td>                                        
                                        <td>{{$bumil->riwayat_penyakit}}</td>                                        
                                        <td>{{$bumil->riwayat_alergi}}</td>                                        
                                        <td>{{$bumil->jumlah_persalinan}}</td>
                                        <td>{{$bumil->jumlah_keguguran}}</td>                                       
                                        <td>{{$bumil->jumlah_anak_hidup}}</td>                                        
                                        <td>{{$bumil->jumlah_lahir_mati}}</td>                                        
                                        <td>{{$bumil->jarak_kehamilan}}</td>                                        
                                        <td>{{$bumil->status_imunisasi_terakhir}}</td>
                                        <td>{{$bumil->penolong_persalinan}}</td>
