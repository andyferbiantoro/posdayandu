...
<head>
    ...
    <title>Entri Data kontrol Ibu Hamil</title>
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                             <a href="{{ route('ibu-createibu') }} "><button class="btn btn-primary">Entri Ibu Hamil</button></a>
                             <a href="{{ route('ibu-createkontrol') }} "><button class="btn btn-primary">Entri Kontrol Baru</button></a>
                             <a href="{{ route('kader-entri') }}"><button class="btn btn-warning">Halaman Anak</button></a>
                            
                            <div class="table-responsive"><br>
                            <form action="{{url('ibu-cari')}}" method="GET">
                                        <label> Cari Nama Ibu </label>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="cari" placeholder="Cari nama ibu" value="{{ old('cari') }}">
                                            </div>
                                            <div class="col">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @php
                                            $no = 1;
                                        @endphp
                                       @foreach($ibuhamil as $key => $bumil)
                                        <tr>
                                            <td class="text-center">{{$ibuhamil->firstItem() + $key}} </td>
                                            <td class="text-center">{{date("j F Y", strtotime($bumil->tanggal))}}</td>
                                            <td class="text-center">{{$bumil->ibu_hamil->ibus->nama}}</td>
                                            <td class="text-center">Ibu Hamil</td>
                                            <td align="center">
                                                <a href="{{route('ibu-detail',$bumil->id)}}"><button class="btn btn-warning">Detail</button></a>
                                                <a href="{{url('ibu-editkontrol',$bumil->id)}}"><button class="btn btn-success">Edit</button></a>
                                                <a href="{{route('ibu_delete',$bumil->id)}}"><button class="btn btn-danger">Hapus</button></a>
