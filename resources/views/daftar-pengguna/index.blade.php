                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="table-responsive"><br>
                             <form action="{{url('kader-daftar_pengguna_cari')}}" method="GET">
                                        <label> Cari Nama Pengguna </label>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="cari" placeholder="Cari Nama Pengguna .." value="{{ old('cari') }}">
                                            </div>
                                            <div class="col">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @php
                                            $no = 1;
                                        @endphp
                                       @foreach($Dataibu as $key => $ibu)
                                        <tr>
                                            <td class="text-center">{{$Dataibu ->firstItem() + $key}} </td>
                                            <td class="text-center">{{$ibu->nama}} </td>
                                            <td class="text-center"> {{$ibu->status}} </td>
                                            <td class="text-center">{{$ibu->jumlah_anak}}  </td>
                                            <td align="center">
                                                <a href="{{url('daftar_pengguna-edit',$ibu->id)}}"><button class="btn btn-success">Edit</button></a>
