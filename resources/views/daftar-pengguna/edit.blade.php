...
<head>
    ...
    <title>Edit Data Daftar Pengguna</title>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
       ...
       <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item" style="background-color: #a21000; border-radius: 5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="{{ route('kader-daftar_pengguna') }}"><i data-feather="grid" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Daftar" style="color: white">Daftar Pengguna</span></a>
                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">EDIT DATA DAFTAR PENGGUNA</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-daftar_pengguna') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body" >
                                <form method="post" action="{{url('/daftar_pengguna-update',$update->id)}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                                ...
                                                <label> Pilih Nama Ibu</label>
                                                    <select name="nama" class="form-control">
                                                        @foreach ($updatex as $updates)
                                                            <option value="{{$update->nama}}"> {{$updates->nama }} </option>
                                                        @endforeach
                                                    </select>
                                             </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan Nama Ibu"  required="" value="{{$updates->nik}}" />
                                            </div>

                                            <div class="form-group">
                                                <label for="status">Status</label>
                                                <input type="text" class="form-control" id="status" name="status" placeholder="" required="" value="{{$updates->status}}"/>
                                            </div>

                                            <div class="form-group">
                                                <label for="jumlah_anak">Jumlah Anak</label>
                                                <input type="text" class="form-control" id="jumlah_anak" name="jumlah_anak" placeholder="" required="" value="{{$updates->jumlah_anak}}"/>
                                            </div>
