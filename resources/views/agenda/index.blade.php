...
<body class="vertical-layout vertical-menu-modern bordered-layout  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="" data-layout="bordered-layout">
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <form action="{{url('agenda_cari')}}" method="GET">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($Dataagenda as $key => $agenda)

                                        <tr>
                                            <td class="text-center">{{$Dataagenda ->firstItem() + $key}} </td>
 ...
 -->                            <a href="{{ route('kader-riwayatagenda') }}"><button class="btn btn-success">Riwayat</button></a>
                            </div>
                        </div>
                    </div>
                </div>
