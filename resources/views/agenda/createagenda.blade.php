...
<head>
    ...
    <title>Entri Baru Data Agenda</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">TAMBAH DATA AGENDA</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-agenda') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                 <form method="post" action="{{route('kader-addagenda')}}" enctype="  multipart/form-data">
                                        {{csrf_field()}}
                                <div class="row">
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" class="form-control" name="waktu" id="waktu" placeholder="" required="" />
                                            </div>
