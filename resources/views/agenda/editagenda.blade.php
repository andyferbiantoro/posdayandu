                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">EDIT DATA AGENDA</h2>
                            </div>
                            <div class="card-body">
                             <a href="{{ route('kader-agenda') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                 <form method="post" action="{{url('kader-updateagenda',$update->id)}}" enctype="  multipart/form-data">
                                        {{csrf_field()}}
                                <div class="row">
                                        <div class="col-xl-6 col-md-8 col-12 mb-1">
                                           ...
                                           <div class="form-group">
                                                <label> Pilih Nama Ibu</label>
                                                    <select name="id_ibu" class="form-control">
                                                        @foreach ($updatex as $updates)
                                                            <option value="{{$update->id_ibu}}"> {{$updates->ibu->nama}} </option>
                                                        @endforeach
                                                    </select>
                                             </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="datetime" class="form-control" id="waktu" name="waktu" placeholder=""  required="" value="{{$updates->waktu}}" />
                                            </div>

                                            <div class="form-group">
                                                <label> Pilih Jenis Agenda</label>
                                                    <select name="jenis" class="form-control"> 
                                                            <option>Kunjungan Rumah</option>
                                                            <option>Kunjungan Pos</option>
                                                    </select>
                                             </div>
