    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item" style="background-color: #a21000; border-radius: 5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="{{ route('kader-agenda') }}"><i data-feather="calendar" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Agenda" style="color: white">Agenda</span></a>
                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                               <h1>Riwayat Agenda</h1>
                            </div>
                            <div class="card-body">
                             
                            
                            <div class="table-responsive"><br>
                            <form action="{{url('agenda_riwayat_cari')}}" method="GET">
                                        <label> Cari Agenda </label>
                                        <div class="form-row">
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="cari" placeholder="Cari agenda .." value="{{ old('cari') }}">
                                            </div>
                                            <div class="col">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($Datariwayat as $key => $agenda)

                                        <tr>
                                            <td class="text-center">{{$Datariwayat->firstItem() + $key}} </td>
                                            <td class="text-center">{{date("j F Y, H:i ", strtotime($agenda->waktu))}} WIB</td>
                                            <td class="text-center">{{$agenda->ibu->nama}} </td>
                                            <td class="text-center">{{$agenda->jenis}} </td>
                                            <td align="center">
                                              
                                                <a href="{{url('kader-editagenda',$agenda->id)}}"><button class="btn btn-success">Edit</button></a>
                                               <a href="{{route('agenda-delete',$agenda->id)}}"><button class="btn btn-danger">Hapus</button></a>
                                                 @include('sweet::alert')
                                            </td>
                                        </tr>
...
<br><br>
                                <div class="left">
                                    Menampilkan agenda
                                    {{$Datariwayat->firstItem()}}
                                    sampai
                                    {{$Datariwayat->lastItem()}}
                                    dari 
                                    {{$Datariwayat->total()}}
                                    Riwayat agenda
                                </div>
                            ...
                            <a href="{{ route('kader-createagenda') }}"><button class="btn btn-primary">Tambah Agenda</button></a>
                            <!-- <a href="#"><button class="btn btn-danger">Hapus</button></a>
 -->                            <a href="{{ route('kader-agenda') }}"><button class="btn btn-danger">Kembali</button></a>
                            </div>
                        </div>
                    </div>
                </div>
