    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item" style="background-color: #a21000; border-radius:5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="#"><i data-feather="home" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Dashboards" style="color: white">Dashboards</span><span class="badge badge-light-warning badge-pill ml-auto mr-1"></span></a> 
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="shopping-cart"></i><span class="menu-title text-truncate" data-i18n="Shop">Toko</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item" data-i18n="List">Produk</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item" data-i18n="Preview">Penjualan</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span class="menu-item" data-i18n="Edit">Atur Toko</span></a>
                        </li>  
                    </ul>
                </li>
                ...
                <section id="dashboard-analytics">
                    <div class="row match-height">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="card card-congratulations" style="background:#a21000">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-center">
                                        <h1 class="mb-1 text-white">Halo Kader {{ Auth::user()->name }}</h1>
                                        <p class="card-text m-auto w-75">
                                           Wahh..Semangat yaa untuk selalu menjadi <br>
                                           #PahlawanPosDayandu
                                        </p>
                                    </div>
                                </div>
                          ...
                          <div class="col-lg-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between pb-0">
                                    <h4 class="card-title">Kode Posyandu</h4><br><br>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 d-flex flex-column flex-wrap text-center">
                                            <div class="text-center">      
                                                <!-- <img src="../img/posdayandu.png">

 -->                                               {!! QrCode::size(200)->generate(Auth::user()->id_posyandu); !!}
                                    ...
                                    <div class="row pb-50">
                                        <div class="col-sm-6 col-12 d-flex justify-content-between flex-column order-sm-1 order-2 mt-1 mt-sm-0">
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                @foreach ($namaposyandu as $namapos)
                                                <p class="card-title">Pengguna {{$namapos->nama}}</p>
                                                @endforeach
                                                <h2 class="font-weight-bolder mb-25">{{$penggunaposyandu}} Orang</h2>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-12 d-flex justify-content-between flex-column order-sm-1 order-2 mt-1 mt-sm-0">
                                            <div class="mb-1 mb-sm-0">
                                              <div>
                                                  <h2 class="font-weight-bolder mb-25">Rating Pelayanan</h2>
                                              </div><br><br>
                                                <div class="ratings">
                                                    <div class="empty-stars-detail" />
                                                         <div class="full-stars-detail" style="width:90%" /></div>        
                                                    </div>
                                                    <h2 class="font-weight-bolder mb-25">4,5</h2>
                                                </div>
                                            </div>       
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">   
                                    <h2 class="font-weight-bolder mt-1">Rating Penjualan</h2>
                                    <div class="ratings">
                                        <div class="empty-stars-detail" />
                                            <div class="full-stars-detail" style="width:90%" /></div>        
                                        </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    ...
                                    <h3 class="font-weight-bolder mt-1">Agenda hari ini <br></h3>
                                     <p class="card-text">{{$k_rumah}} Kunjungan Rumah <br></p>
                                    <p class="card-text">{{$k_pos}} Kunjungan Pos</p>
                                </div>
                                <div> </div>
                            </div>
                        </div>
