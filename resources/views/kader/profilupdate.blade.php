    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"  style="background-color: #a21000; border-radius: 5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="{{ route('kader-profil') }}"><i data-feather="user" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Profil" style="color: white">Profil</span></a>
                </li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">PROFIL UPDATE</h2>
                            </div>
                            <div class="card-body">
                                 <div class="row">
                                @foreach($datakader as $kader)
                                    <div class="col-xl-6 col-md-8 col-12 mb-1">
                                        <form method="post" action="{{url('updatefoto-kader',$kader->id)}}" enctype="multipart/form-data">
                                             {{csrf_field()}}
                                             {{method_field('PUT')}}
                                               <span class="avatar">
                                                        <img src="{{asset('uploads/fotoprofil/'.$kader->image)}}" alt="image" width="150px" height="150px">
                                                     </span><br><br>
                                ...
                                <div  class="col-xl-6 col-md-8 col-12 mb-1"><br>
                                <form method="post" action="{{url('updateprofil-kader',$kader->id_user)}}" enctype="multipart/form-data">
                                    @endforeach
                                        ...
                                        @foreach($datakader as $kader)
                                            ...
                                            <div class="form-group">
                                                <input type="hidden" class="form-control" id="id_user" name="id_user" value="{{ Auth::user()->id}}" placeholder=""  />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nik" name="nik" placeholder=" Masukkan NIK Kader" value="{{$kader->nik}}"/>
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="tanggal_aktif">Tanggal Aktif</label>
                                                <input type="date" class="form-control" id="tanggal" name="tanggal_aktif" placeholder=""  value="{{$kader->tanggal_aktif}}"/>
                                            </div>
