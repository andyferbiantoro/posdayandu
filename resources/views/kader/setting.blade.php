        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="d-flex align-items-center" href="{{ route('kader-profil') }}"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Profil">Profil</span></a>
                 ...
                 <li class=" nav-item" style="background-color: #a21000; border-radius: 5px; margin-left: 15px; margin-right: 15px"><a class="d-flex align-items-center" href="{{ route('kader-setting') }}"><i data-feather="package" style="color: white"></i><span class="menu-title text-truncate" data-i18n="Form Wizard" style="color: white">Pengaturan Akun</span></a>
                </li>
                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @foreach($akunkader as $kader)
                                <form method="post" action="{{url('kader-updateakun',$kader->id)}}" enctype="multipart/form-data">
                                    @endforeach
                                <div class="row">
                                        ...
                                        <div  class="col-xl-6 col-md-8 col-12 mb-1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="email" name="email" placeholder=" Masukkan NIK Kader" value="{{$kader->email}}"/>
                                                <p>Status {{ Auth::user()->status }}</p>
                                            </div>

                                            <div class="form-group">
                                                <label for="nohp">No Whatsapp Kader</label>
                                                <input type="text" class="form-control" id="nohp" name="nohp" placeholder=" " value="{{$kader->nohp}}"/>   
                                            </div>
                                ...
                                @endforeach
                                   <div class="form-group">
                                               Ubah Password Anda ? <a href="{{route('kader-editpassword')}}">Ubah Password</a>
                                            </div>
