                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">PROFIL BARU</h2>
                            </div>
                            <div class="card-body">
                                <form method="post" action="{{route('addprofil-kader')}}" enctype="multipart/form-data">
                                <div class="row">
                                        ...
                                        <div  class="col-xl-6 col-md-8 col-12 mb-1">
                                           ...
                                           <!--  <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nama"  name="nama" placeholder="Masukkan Nama Kader" />
                                            </div> -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="nik" name="nik" placeholder=" Masukkan NIK Kader" required="" />
                                            </div>                                            

                                            <div class="form-group">
                                                <label for="tanggal_aktif">Tanggal Aktif</label>
                                                <input type="date" class="form-control" id="tanggal" name="tanggal_aktif" placeholder="" required="" />
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="image">Foto Profil</label>
                                                <input type="file" class="form-control" id="image" name="image" placeholder=" Masukkan NIK Kader" required="" />
                                            </div> 
