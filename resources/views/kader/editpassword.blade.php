                ...
                <section id="dashboard-analytics">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            	<a href="{{ route('kader-setting') }} "><button class="btn btn-danger">kembali</button></a>
                            </div>
                            <div class="card-body">
                                @foreach($akunkader as $kader)
                                <form method="post" action="{{url('kader-updatepassword',$kader->id)}}" enctype="multipart/form-data">
                                    @endforeach
                                	<div class="row">
